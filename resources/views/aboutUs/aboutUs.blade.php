                    ...
                    <div class="tournament-card-inner">
                        ...
                        <div class="tournament-card-img">
                            <div class="card-title-wrap text-md-end">
                                <h3 class="tournament-card-title"><a href="/tournament_Details">The Lion King</a></h3>
                ...
                <div class="tournament-card style3">
                    ...
                    <div class="tournament-card-inner">
                        <div class="tournament-card-img">
                            ...
                            <div class="card-title-wrap">
                                <h3 class="tournament-card-title"><a href="/tournament_Details">Assassin Team</a></h3>
                                <h6 class="tournament-card-subtitle">Champion Team</h6>
                            </div>
                        </div>
                        ...
                        <div class="tournament-card-img">
                            <div class="card-title-wrap text-md-end">
                                <h3 class="tournament-card-title"><a href="/tournament_Details">Cyberpunk King</a></h3>
                                <h6 class="tournament-card-subtitle">Runner Up Team</h6>
                            </div>
            ...
            <div class="col-12">
                <div class="tournament-card style3">
                    ...
                    <div class="tournament-card-inner">
                        ...
                        <div class="tournament-card-img">
                            <div class="card-title-wrap text-md-end">
                                <h3 class="tournament-card-title"><a href="/tournament_Details">X-XBO Ninja</a></h3>
                                <h6 class="tournament-card-subtitle">Champion Team</h6>
                            </div>
