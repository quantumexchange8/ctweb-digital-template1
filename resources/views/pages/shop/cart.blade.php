                ...
                <tbody>
                    <tr class="cart_item">
                        <td data-title="Product">
                            <a class="cart-productimage" href="/shop_Details"><img width="91" height="91" src="assets/img/product/product_thumb_1_1.png" alt="Image"></a>
                        </td>
                        <td data-title="Name">
                            <a class="cart-productname" href="/shop_Details">Gaming Headphone</a>
                        </td>
                        <td data-title="Price">
                    ...
                    <tr class="cart_item">
                        <td data-title="Product">
                            <a class="cart-productimage" href="/shop_Details"><img width="91" height="91" src="assets/img/product/product_thumb_1_2.png" alt="Image"></a>
                        </td>
                        <td data-title="Name">
                            <a class="cart-productname" href="/shop_Details">Gaming Mouse</a>
                        </td>
                        <td data-title="Price">
                            <span class="amount"><bdi><span>$</span>18</bdi></span>
                        </td>
                    ...
                    <tr class="cart_item">
                        <td data-title="Product">
                            <a class="cart-productimage" href="/shop_Details"><img width="91" height="91" src="assets/img/product/product_thumb_1_3.png" alt="Image"></a>
                        </td>
                        <td data-title="Name">
                            <a class="cart-productname" href="/shop_Details">Gaming Keyboard</a>
                        </td>
                        <td data-title="Price">
                            <span class="amount"><bdi><span>$</span>18</bdi></span>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="actions">
                            ...
                            <a href="/shop" class="th-btn">Continue Shopping</a>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="row justify-content-end">
            <div class="col-md-8 col-lg-7 col-xl-6">
                ...
                <div class="wc-proceed-to-checkout mb-30">
                    <a href="/checkout" class="th-btn">Proceed to checkout</a>
                </div>
            </div>
        </div>
    </div>
