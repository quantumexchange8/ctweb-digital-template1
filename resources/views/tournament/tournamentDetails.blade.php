                    ...
                    <div class="tournament-card-content">
                        <div class="tournament-card-details" data-mask-src="assets/img/bg/tournament-card2-bg.png">
                            ...
                            <div class="card-title-wrap">
                                <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                <h3 class="tournament-card-title"><a href="/tournament_Details">Lion King</a></h3>
                            </div>
                        </div>
            ...
            <div class="col-lg-8">
                <div class="page-single tournament-details-wrap">
                    <div class="page-content">
                        ...
                        <p class="">Gamers can join local gaming meetups, participate in gaming events, or connect with like-minded individuals through online forums and social media groups. Engaging with the community helps build connections and creates opportunities for collaborative gaming experiences.</p>
                        <p class="mb-30">Emerging trends in the esports industry include the growth of mobile esports, the integration of virtual reality in gaming experiences, and the increasing involvement of traditional sports organizations in esports partnerships and investments.</p>

                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="page-img">
                                    <img class="w-100" src="assets/img/tournament/tournament-s-1-1.png" alt="img">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="page-img">
                                    <img class="w-100" src="assets/img/tournament/tournament-s-1-2.png" alt="img">
                                </div>
                            </div>
                        </div>

                        <p class="mb-n2 mt-35"> Storytelling is a crucial element in modern video game design, creating immersive and engaging experiences. Games with compelling narratives often resonate more with players, adding depth to the overall gaming experience.</p>
                            ...
                            <div class="th-post-comment">
                                ...
                                <div class="comment-content">
                                    ...
                                    <div class="reply_and_edit">
                                        <a href="/blog_Details" class="reply-btn"><i class="fas fa-reply"></i>Reply</a>
                                    </div>
                                </div>
                            </div>
                            <ul class="children">
            ...
            <div class="col-lg-4">
                <aside class="sidebar-area">
                        ...
                        <div class="widget-tournament-info">
                            <div class="next-match-list">
                                <div class="player-info">
                                    ...
                                    <h4 class="player-title"><a href="/players_Details">Assassin</a></h4>
                                ...
                                <div class="player-info">
                                    ...
                                    <h4 class="player-title"><a href="/players_Details">Badgamer</a></h4>
                                    <div class="player-social">
                                        <span>Watch</span>
                                        <a href="https://www.twitch.tv/"><i class="fa-brands fa-twitch"></i></a>
                                        <a href="https://www.youtube/"><i class="fa-brands fa-youtube"></i></a>
                    ...
                    <div class="widget  ">
                        ...
                        <a href="/tournament" class="widget-advertise text-center">
